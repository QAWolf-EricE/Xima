...
test("handset_registration_srv_failover_tests_no_responses", async () => {
 // Step 1. Handset Registration SRV Failover Tests - NO_RESPONSES
  //--------------------------------
  // Arrange:
  //--------------------------------
  ...
  const skill = "18";
  const skillDigit = [8];
  const email = "xima+webrtcagent76@qawolf.email";
  ...
  const sipOutageOption = "NO_RESPONSES";
  let callId;
